    ...
    FloatLayout:                            #in decending order as seen in GUI
        ...
        Button:
            ...
            on_press:
                ...
                elif(root.manager.get_screen('soft_tap').start.flag == '1'):root.manager.get_screen('soft_tap').start.flag = '0';root.manager.get_screen('soft_tap').start.text = 'Done / Stop'
